...
**131 skills across 23 categories** — hand-curated, production-ready, and compatible with every major agent: Mercury, Claude Code, Codex CLI, OpenClaw, Hermes, Cursor, and Gemini CLI.
...
| [Media Download](./categories/media-download/) | 5 | yt-dlp wrappers, audio extraction, batch downloading, platform-specific patterns, GitHub repo promo videos |
